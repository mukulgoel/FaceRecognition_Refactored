...
import eigencomputation.EigenFaceCreator;

public class TestFaceRecognition {

	private static final String USAGE_ERROR = "Usage: java TestFaceRecognition <directory of training images> <image to test against>";
